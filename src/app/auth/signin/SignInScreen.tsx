        ...
        <div className="bg-[#0d0d20] border border-[#1a1a2e] rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex rounded-lg overflow-hidden border border-[#2a2a3e] mb-6">
            <button
              ...
              className={
                mode === "signin"
                  ? "flex-1 py-2 font-mono text-xs tracking-widest font-bold bg-[#00ff88]/10 text-[#00ff88]"
                  : "flex-1 py-2 font-mono text-xs tracking-widest font-bold text-gray-500"
              }
            >
              SIGN IN
            </button>
            ...
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: loading
                    ? "none"
                    : "0 0 16px rgba(0,255,136,0.25), inset 0 0 16px rgba(0,255,136,0.05)",
